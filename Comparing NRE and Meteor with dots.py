# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 10:39:08 2024
...
pivot_df.plot(ax=ax1, kind='line', marker='o', label='NRE Occurrence')
...
ax2.plot(df_grouped['local_datetime'], df_grouped['count'], label='Meteor Occurrence Count', linestyle='--', color='black')
